        ...
        <div  className="navbar w-11/12 mx-auto">
          <div className="navbar-start">
            ...
            <Link to={'/'} className="flex items-center gap-2 text-xl text-secondary">
                {/* <FaCanadianMapleLeaf className="w-[40px] h-[35px]"/> */}
                <img src={fineaseLogo} className="w-[40px] h-[35px]" alt="" />
              ...
              {/* {
                ...
                <div className="dropdown dropdown-end">
                  ...
                  <ul tabIndex="-1" className="dropdown-content menu bg-[#f7fee7] rounded-box z-2 w-52 p-2 shadow-sm">
                    ...
                    <button onClick={handleLogout} className="btn bg-green-600 text-white mt-3 w-fit mx-auto rounded-4xl">Logout</button> 
                  </ul>
              </div>
                </>
                : <>                 */}
